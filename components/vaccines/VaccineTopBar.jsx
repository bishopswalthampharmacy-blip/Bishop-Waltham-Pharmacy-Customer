    ...
    return (
        <div className="bg-white rounded-xl p-4 mb-6 shadow-sm border">
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
                {/* Category Selector */}
                <div className="flex-1 w-full lg:w-auto max-w-xs">
                    {categories.length > 0 ? (
                        <CustomDropdown
                        ...
                        <div className="w-full">
                            ...
                            <div className="w-full px-3 py-2 border border-gray-200 rounded-lg bg-gray-100 text-gray-500 font-instrument text-sm">
