  ...
  return (
    <>
      ...
      <div className="relative w-full h-48 sm:h-64 md:h-72 overflow-hidden">
        <Image src="/assets/dd2.jpg" alt="Booking page hero image" fill className="object-cover" priority />
      ...
      <div className="relative min-h-screen w-full flex bg-gray-50 font-instrument">
        <div className="absolute inset-0 z-0 overflow-hidden">
          <Image src="/assets/booknow.webp" alt="Booking decorative background image" fill className="object-cover" priority />
